...
############################################################################################
txt_names = sorted(
    glob.glob("/home/junya/Research/Dataset/C2C12/ann_data/seg02_600-700.txt")
)
save_path = "/home/junya/Research/Dataset/C2C12/CMF"
SGM = 5  # CMFの幅/2の値
############################################################################################
if __name__ == "__main__":
    ...
    for time_late in time_lates:
        for seq in seqs:
            save_CMP_path = Path(f"./images/Elmer_phase/CMF_6_{time_late}")
            ...
            # root_path = Path(f"/home/kazuya/main/C2C12_9_{time_late}/sequ{seq}")
            root_path = Path(
